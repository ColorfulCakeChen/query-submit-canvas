...
//      [ filterHeight_OneStep,  "Max", false ],
      ...
      [ filterHeight_OneStep, "Conv",  true,        "", false, false,        "" ],
      [ filterHeight_OneStep, "Conv", false,        "",  true, false,        "" ],
      [ filterHeight_OneStep, "Conv",  true,        "",  true, false,        "" ],
      [ filterHeight_OneStep, "Conv", false,        "",  true,  true,        "" ],
      ...
      [                    2, "Conv",  true,        "", false, false,        "" ],
      [                    2, "Conv", false,        "",  true, false,        "" ],
      [                    2, "Conv",  true,        "",  true, false,        "" ],
      [                    2, "Conv", false,        "",  true,  true,        "" ],
      ...
      [                    3, "Conv",  true,        "", false, false,        "" ],
      [                    3, "Conv", false,        "",  true, false,        "" ],
      [                    3, "Conv",  true,        "",  true, false,        "" ],
      [                    3, "Conv", false,        "",  true,  true,        "" ],
      ...
      [                    5, "Conv",  true,        "", false, false,        "" ],
      [                    5, "Conv", false,        "",  true, false,        "" ],
      [                    5, "Conv",  true,        "",  true, false,        "" ],
      [                    5, "Conv", false,        "",  true,  true,        "" ],
      ...
      [                    7, "Conv",  true,        "", false, false,        "" ],
      [                    7, "Conv", false,        "",  true, false,        "" ],
      [                    7, "Conv",  true,        "",  true, false,        "" ],
      [                    7, "Conv", false,        "",  true,  true,        "" ],
      ...
      [                    9, "Conv",  true,        "", false, false,        "" ],
      [                    9, "Conv", false,        "",  true, false,        "" ],
      [                    9, "Conv",  true,        "",  true, false,        "" ],
      [                    9, "Conv", false,        "",  true,  true,        "" ],
