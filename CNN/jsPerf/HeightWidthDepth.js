...
//       [ height, depth, targetHeight, filterHeight_OneStep, "Conv",   "relu6",  true,   "relu6" ],
      ...
      [ height, depth, targetHeight, filterHeight_OneStep, "Conv",    "tanh",  true ],
      [ height, depth, targetHeight, filterHeight_OneStep, "Conv",    "tanh",  true,    "tanh" ],
...
//       [ height, depth, targetHeight,                    2, "Conv",   "relu6",  true,   "relu6" ],
      ...
      [ height, depth, targetHeight,                    2, "Conv",    "tanh",  true ],
      [ height, depth, targetHeight,                    2, "Conv",    "tanh",  true,    "tanh" ],
...
//       [ height, depth, targetHeight,                    3, "Conv",   "relu6",  true,   "relu6" ],
      ...
      [ height, depth, targetHeight,                    3, "Conv",    "tanh",  true ],
      [ height, depth, targetHeight,                    3, "Conv",    "tanh",  true,    "tanh" ],
...
//       [ height, depth, targetHeight,                    5, "Conv",   "relu6",  true,   "relu6" ],
      ...
      [ height, depth, targetHeight,                    5, "Conv",    "tanh",  true ],
      [ height, depth, targetHeight,                    5, "Conv",    "tanh",  true,    "tanh" ],
      [ height, depth, targetHeight,                    5, "Conv",     "sin",  true ],
      [ height, depth, targetHeight,                    5, "Conv",     "sin",  true,     "sin" ],

      [ height, depth, targetHeight,                    7, "Conv",        "", false ],
      [ height, depth, targetHeight,                    7, "Conv",        "",  true ],
//       [ height, depth, targetHeight,                    7, "Conv",    "relu",  true ],
//       [ height, depth, targetHeight,                    7, "Conv",    "relu",  true,    "relu" ],
//       [ height, depth, targetHeight,                    7, "Conv",   "relu6",  true ],
//       [ height, depth, targetHeight,                    7, "Conv",   "relu6",  true,   "relu6" ],
      [ height, depth, targetHeight,                    7, "Conv", "sigmoid",  true ],
      [ height, depth, targetHeight,                    7, "Conv", "sigmoid",  true, "sigmoid" ],
      [ height, depth, targetHeight,                    7, "Conv",    "tanh",  true ],
      [ height, depth, targetHeight,                    7, "Conv",    "tanh",  true,    "tanh" ],
      [ height, depth, targetHeight,                    7, "Conv",     "sin",  true ],
      [ height, depth, targetHeight,                    7, "Conv",     "sin",  true,     "sin" ],

      [ height, depth, targetHeight,                    9, "Conv",        "", false ],
      [ height, depth, targetHeight,                    9, "Conv",        "",  true ],
//       [ height, depth, targetHeight,                    9, "Conv",    "relu",  true ],
//       [ height, depth, targetHeight,                    9, "Conv",    "relu",  true,    "relu" ],
//       [ height, depth, targetHeight,                    9, "Conv",   "relu6",  true ],
//       [ height, depth, targetHeight,                    9, "Conv",   "relu6",  true,   "relu6" ],
      [ height, depth, targetHeight,                    9, "Conv", "sigmoid",  true ],
      [ height, depth, targetHeight,                    9, "Conv", "sigmoid",  true, "sigmoid" ],
      [ height, depth, targetHeight,                    9, "Conv",     "tanh",  true ],
      [ height, depth, targetHeight,                    9, "Conv",     "tanh",  true,   "tanh" ],
      [ height, depth, targetHeight,                    9, "Conv",     "sin",  true ],
      [ height, depth, targetHeight,                    9, "Conv",     "sin",  true,     "sin" ],
    ];
