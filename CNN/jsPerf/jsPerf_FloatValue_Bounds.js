...
//!!! ...unfinished... (2022/02/21)
    new Cases( 4, [
      new Case( 40, [  1,  3 ], [  2,  4 ],  5, [  2,  3 ], [  4,  6 ], [  3,  8 ], [   5,  10 ] ),
      new Case( 41, [ -1,  3 ], [  2,  4 ],  5, [  2,  3 ], [  2,  6 ], [ -4,  8 ], [  -5,  10 ] ),
      new Case( 42, [  1, -3 ], [  2,  4 ],  5, [  2,  2 ], [  1,  5 ], [ -8,  4 ], [ -10,   5 ] ),
      new Case( 43, [ -1, -3 ], [  2,  4 ],  5, [  2,  2 ], [  1,  3 ], [ -8, -3 ], [ -10,  -5 ] ),
    ] ),

    new Cases( 5, [
      new Case( 50, [  1,  3 ], [ -2,  4 ], -5, [  1,  3 ], [ -2,  6 ], [ -6,  8 ], [ -10,  -5 ] ),
      new Case( 51, [ -1,  3 ], [ -2,  4 ], -5, [ -1,  3 ], [ -4,  6 ], [ -6,  8 ], [ -10,   5 ] ),
      new Case( 52, [  1, -3 ], [ -2,  4 ], -5, [ -2,  1 ], [ -5,  5 ], [ -8,  6 ], [  -5,  10 ] ),
      new Case( 53, [ -1, -3 ], [ -2,  4 ], -5, [ -2, -1 ], [ -5,  3 ], [ -8,  6 ], [   5,  10 ] ),
    ] ),

    new Cases( 6, [
      new Case( 60, [  1,  3 ], [  2, -4 ],  5, [  1,  2 ], [ -3,  5 ], [ -8,  6 ], [   5,  10 ] ),
      new Case( 61, [ -1,  3 ], [  2, -4 ],  5, [ -1,  2 ], [ -5,  5 ], [ -8,  6 ], [  -5,  10 ] ),
      new Case( 62, [  1, -3 ], [  2, -4 ],  5, [ -3,  1 ], [ -6,  4 ], [ -6,  8 ], [ -10,   5 ] ),
      new Case( 63, [ -1, -3 ], [  2, -4 ],  5, [ -3, -1 ], [ -6,  2 ], [ -6,  8 ], [ -10,  -5 ] ),
    ] ),

    new Cases( 7, [
      new Case( 70, [  1,  3 ], [ -2, -4 ], -5, [ -2, -2 ], [ -3, -1 ], [ -8, -3 ], [ -10,  -5 ] ),
      new Case( 71, [ -1,  3 ], [ -2, -4 ], -5, [ -2, -2 ], [ -5, -1 ], [ -8,  4 ], [ -10,   5 ] ),
      new Case( 72, [  1, -3 ], [ -2, -4 ], -5, [ -3, -2 ], [ -6, -2 ], [ -4,  8 ], [  -5,  10 ] ),
      new Case( 73, [ -1, -3 ], [ -2, -4 ], -5, [ -3, -2 ], [ -6, -4 ], [  3,  8 ], [   5,  10 ] ),
    ] ),
