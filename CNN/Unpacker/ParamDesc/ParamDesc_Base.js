 ...
 * A: Let different parameter descriptions (ParamDesc) share the same value
 *    description (ValueDesc). It is especially useful for integer parameter
 *    ( new ParamDesc.Base( paramName, new ValueDesc.Int() ) ). For
 *    non-converting and boolean parameter, using ParamDesc.Same and
 *    ParamDesc.Bool is enough.
 *
 * @example
 ...
 *   The name of the parameter. It is a string. It should be a legal identifer
 * too (i.e. A-Z, a-z, 0-9 (not at first character), and "_").
 *
 * @member {ValueDesc.Xxx} valueDesc
 *   The description of the parameter's all possible values. It should be a
 * ValueDesc.Xxx object (one of ValueDesc.Same, ValueDesc.Bool, ValueDesc.Int).
 * For example, ValueDesc.Same.Singleton, ValueDesc.Bool.Singleton.
 *
 * @member {number} seqId
 *   The sequence id of the parameter. It is filled by
 * ParamDesc.SequenceArray's constructor. And it is used as the array index
 * into Weights.Params.
 *
 */
 ...
 *   The range of the parameter's all possible values. It is a
 * ValueDesc.Same object.
 */
 ...
 *   The integer range of the parameter's all possible values. It is a
 * ValueDesc.Bool object.
 */
class Int extends ParamDesc_Base {
  constructor( paramName,
    valueIntegerMin, valueIntegerMax,
    valueNames = [], valueObjects = [] ) {

    super( paramName, new ValueDesc.Int(
      valueIntegerMin, valueIntegerMax, valueNames, valueObjects ) );
  }
}
 ...
 *   The range of the parameter's all possible values. It is a
 * ValueDesc.ActivationFunction object.
 */
 ...
 *   The range of the parameter's all possible values. It is a
 * ValueDesc.ConvBlockType object.
 */
 ...
 *   The range of the parameter's all possible values. It is a
 * ValueDesc.AvgMax_Or_ChannelMultiplier object.
 */
...
/**
 * Describe some properties of an squeeze-and-excitation channel count divisor
 * parameter.
 *
 * @member {ValueDesc.AvgMax_Or_ChannelMultiplier} valueDesc
 *   The range of the parameter's all possible values. It is a
 ...
 *   The range of the parameter's all possible values. It is a
 * ValueDesc.ConvStageType object.
 */
