...
/**
 * Describe an array of scale (i.e. multiplier) values, and then an array of
 * translate (i.e. offset; bias) values after the scale. Note that the order is
 * important: scale first, translate second.
 *
...
class ScaleTranslateArray {
  ...
  /**
   * (Re)set all scale-translate values. Default are
   * ( scale = 1, translate = 0 ) (i.e. no scale and no translate).
   *
   * @return {ScaleTranslateArray}
   *   Return this (modified) object whose values are (re)set as specified
   * values.
   */
   ...
   *
   * @return {ScaleTranslateArray}
   *   Return this (modified) object whose values are copied from
   * aScaleTranslateArray.
   */
   ...
   *
   * @return {ScaleTranslateArray}
   *   Return this (modified) object whose values could undo
   * aScaleTranslateArray.
   */
   ...
   *
   * @return {ScaleTranslateArray}
   *   Return this (modified) object whose values are scale and translate for
   * mapping values from source bounds to target bounds.
   */
   ...
   *
   * @return {ScaleTranslateArray}
   *   Return this (modified) object whose values scaled and translated by the
   * specified scale-translate.
   */
