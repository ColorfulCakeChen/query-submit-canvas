 ...
 * general, an activation function is non-linear in the whole domain. However, inside this special part of the domain, it looks almost
...
class Info {
  ...
  /**
   */
  constructor( nActivationId, inputDomainLinear, outputRange, pfn ) {
