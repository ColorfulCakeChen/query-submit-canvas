...
/*
 * Accodring to testing, the original ShuffleNetV2 is faster than MobileNetV2 in backend CPU. This may result from lesser computation.
 * However, in backend WASM and WEBGL, MobileNetV2 is faster than the original ShuffleNetV2. The possible reason may be that the
 * concatenation-shuffle-split (even using pointwise convolution to achieve) operation is not friendly for WASM and WEBGL.
 *
 ...
 *   - Manipulate the filter weights of pointwise1, depthwise1, pointwise21 so that they achieve the same effect of shuffling but
 *     without concatenation and splitting.
 *
