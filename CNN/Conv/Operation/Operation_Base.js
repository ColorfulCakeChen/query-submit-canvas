      ...
      if ( this.input1 ) {
        if ( this.output0 ) {
          if ( this.output1 ) { //  1. ( .input0, .input1 ) => ( .output0, .output1 )
            ...
            if ( bKeepInputTensor0 ) {
              if ( bKeepInputTensor1 )
                this.apply = Base.apply__i0_i1__o0_o1__k0_k1;
              else
                this.apply = Base.apply__i0_i1__o0_o1__k0_d1;
            } else {
              if ( bKeepInputTensor1 )
                this.apply = Base.apply__i0_i1__o0_o1__d0_k1;
              else
                this.apply = Base.apply__i0_i1__o0_o1__d0_d1;
            }
          } else {              //  2. ( .input0, .input1 ) => ( .output0 )
            this.output0.set_height_width_channelCount_scaleBoundsArray_byTensorPlaceholder( this.input0 );
            if ( bKeepInputTensor0 ) {
              if ( bKeepInputTensor1 )
                this.apply = Base.apply__i0_i1__o0__k0_k1;
              else
                this.apply = Base.apply__i0_i1__o0__k0_d1;
            } else {
              if ( bKeepInputTensor1 )
                this.apply = Base.apply__i0_i1__o0__d0_k1;
              else
                this.apply = Base.apply__i0_i1__o0__d0_d1;
            }
          }
        } else {
          if ( this.output1 ) { //  3. ( .input0, .input1 ) => ( , .output1 )
            ...
            if ( bKeepInputTensor0 ) {
              if ( bKeepInputTensor1 )
                this.apply = Base.apply__i0_i1__o1__k0_k1;
              else
                this.apply = Base.apply__i0_i1__o1__k0_d1;
            } else {
              if ( bKeepInputTensor1 )
                this.apply = Base.apply__i0_i1__o1__d0_k1;
              else
                this.apply = Base.apply__i0_i1__o1__d0_d1;
            }
          } else {              //  4. ( .input0, .input1 ) => (  )
            if ( bKeepInputTensor0 ) {
              if ( bKeepInputTensor1 )
                this.apply = Base.apply__i0_i1__k0_k1;
              else
                this.apply = Base.apply__i0_i1__k0_d1;
            } else {
              if ( bKeepInputTensor1 )
                this.apply = Base.apply__i0_i1__d0_k1;
              else
                this.apply = Base.apply__i0_i1__d0_d1;
            }
          }
        }
      } else {
        if ( this.output0 ) {
          if ( this.output1 ) { //  5. ( .input0 ) => ( .output0, .output1 )
            ...
            if ( bKeepInputTensor0 ) {
              this.apply = Base.apply__i0__o0_o1__k0;
            } else {
              this.apply = Base.apply__i0__o0_o1__d0;
            }
          } else {              //  6. ( .input0 ) => ( .output0 )
            this.output0.set_height_width_channelCount_scaleBoundsArray_byTensorPlaceholder( this.input0 );
            if ( bKeepInputTensor0 ) {
              this.apply = Base.apply__i0__o0__k0;
            } else {
              this.apply = Base.apply__i0__o0__d0;
            }
          }
        } else {
          if ( this.output1 ) { //  7. ( .input0 ) => ( , .output1 )
            this.output1.set_height_width_channelCount_scaleBoundsArray_byTensorPlaceholder( this.input0 );
            if ( bKeepInputTensor0 ) {
              this.apply = Base.apply__i0__o1__k0;
            } else {
              this.apply = Base.apply__i0__o1__d0;
            }
          } else {              //  8. ( .input0 ) => (  )
            if ( bKeepInputTensor0 ) {
              this.apply = Base.apply__i0__k0;
            } else {
              this.apply = Base.apply__i0__d0;
            }
          }
        }
      }
      ...
      if ( this.input1 ) {
        if ( this.output0 ) {
          if ( this.output1 ) { //  9. ( , .input1 ) => ( .output0, .output1 )
            ...
            this.output1.set_height_width_channelCount_scaleBoundsArray_byTensorPlaceholder( this.input1 );
            if ( bKeepInputTensor1 ) {
              this.apply = Base.apply__i1__o0_o1__k1;
            } else {
              this.apply = Base.apply__i1__o0_o1__d1;
            }
          } else {              // 10. ( , .input1 ) => ( .output0 )
            this.output0.set_height_width_channelCount_scaleBoundsArray_byTensorPlaceholder( this.input1 );
            if ( bKeepInputTensor1 ) {
              this.apply = Base.apply__i1__o0__k1;
            } else {
              this.apply = Base.apply__i1__o0__d1;
            }
          }
        } else {
          if ( this.output1 ) { // 11. ( , .input1 ) => ( , .output1 )
            this.output1.set_height_width_channelCount_scaleBoundsArray_byTensorPlaceholder( this.input1 );
            if ( bKeepInputTensor1 ) {
              this.apply = Base.apply__i1__o1__k1;
            } else {
              this.apply = Base.apply__i1__o1__d1;
            }
          } else {              // 12. ( , .input1 ) => (  )
            if ( bKeepInputTensor1 ) {
              this.apply = Base.apply__i1__k1;
            } else {
              this.apply = Base.apply__i1__d1;
            }
          }
        }
        ...
        if ( this.output0 ) {
          if ( this.output1 ) { // 13. (  ) => ( .output0, .output1 )
            ...
            this.apply = Base.apply__o0_o1;
          } else {              // 14. (  ) => ( .output0 )
            this.output0.set_height_width_channelCount_scaleBoundsArray_byTensorPlaceholder( null );
            this.apply = Base.apply__o0;
          }
        } else {
          if ( this.output1 ) { // 15. (  ) => ( , .output1 )
            this.output1.set_height_width_channelCount_scaleBoundsArray_byTensorPlaceholder( null );
            this.apply = Base.apply__o1;
          } else {              // 16. (  ) => (  )
            this.apply = Base.apply__;
          }
        }
