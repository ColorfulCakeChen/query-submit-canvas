 ...
 */
class WorkerInitProgress extends ValueMax.Percentage.Aggregate {
  constructor() {
    let children = [
 ...
 */
class WorkersInitProgress extends ValueMax.Percentage.Aggregate {
  constructor() {
    let children = [
      new WorkerInitProgress(), // Increased when web worker 1 initializing.
      new WorkerInitProgress(), // Increased when web worker 2 initializing.
    ];
