 ...
 *
 * The last PointDepthPoint's pointwise2 of every block without activation function (i.e. strLastActivationNameOfEveryBlock == "")
 * could let the output of neural network be any arbitrary value because it achieves affine (= linear + bias) transformation.
 */
class Config {
  /**
