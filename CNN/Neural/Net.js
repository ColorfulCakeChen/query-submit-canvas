 ...
 *   - strActivationNameAtBlockEnd: null
 *
 ...
 *
 * The last PointDepthPoint's pointwise2 of every block without activation function (i.e. strLastActivationNameOfEveryBlock == "" (or null))
 * could let the output of neural network be any arbitrary value because it will not be restricted by the range of the activation function.
 */
class Config {
  /**
