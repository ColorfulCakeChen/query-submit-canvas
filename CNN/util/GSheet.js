...
class UrlComposer {
   ...
   *
   * @param {string} apiKey
   *   The API key string for accessing the spreadsheet. If not null, Google Sheets API
   * v4 will be used. If null, Google Visualization Table Query API will be used.
   *
