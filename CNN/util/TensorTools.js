...
class Asserter_Equal extends Recyclable.Root {
   ...
   * (per element) is acceptable. Useful for large value. Default is 0.001 (i.e.
   * 0.1% difference is allowed).
   *
   ...
   */
  constructor(
    acceptableDifferenceRate = 0.001, acceptableDifference = 0.00001 ) {
    super();
