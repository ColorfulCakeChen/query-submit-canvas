...
//  }
   ...
   *
   * @return {Iterator}
   *   Return an iterator traverses every td tag inside the htmlString. The captured group 1 of every match is the text of the html td tag
   * (e.g. <td>...</td>). If the td tag contains a div tag (e.g. <td><div>...</div></td>), the captured group 1 of every match is the text
   * of the html div tag.
   */
  static getExtractIterator( htmlString ) {
